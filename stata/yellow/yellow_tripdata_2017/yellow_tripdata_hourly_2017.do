...
// set data name
local dta_name "yellow_tripdata_hourly_2017.dta"


// initial dta file
import delimited "https://s3.amazonaws.com/nyc-tlc/trip+data/yellow_tripdata_2017-01.csv"

gen pickup_time = regexs(1) if regexm(tpep_pickup_datetime, "(^.*)[:][0-9]*[:]")
gen num = 1
